...
Este archivo funciona como indice. El desarrollo completo esta separado por clase dentro de `Teoria_y_Practica/` para que los apuntes sean mas comodos de leer y mantener.

Cada clase sigue el mismo recorrido:
...
| Clase | Temas | Estado | Archivo |
|---|---|---|---|
| 1 | Retornos, distribuciones, momentos, Jarque-Bera y mixturas | Completa | [Abrir Clase 1](Teoria_y_Practica/Clase_01.md) |
...
Antes de cada clase se identifican el PDF teorico, los notebooks, la practica y las bases necesarias. Luego se avanza tema por tema, conectando formulas, implementacion, resultados e interpretacion. Los problemas de rutas o datos quedan señalados al final de cada archivo, separados del contenido conceptual.
